 ...
 */
public class RPDDeployInstance extends Notifier {
    ...
    @Extension
    public static class DeployStepDescriptor extends BuildStepDescriptor<Publisher> {
        ...
        public ListBoxModel doFillCustomProfileItems(@QueryParameter String environment, @QueryParameter String route, @QueryParameter String customProfile) {
