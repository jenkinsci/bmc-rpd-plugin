package com.bmc.rpd.jenkins.plugin.bmcrpd.postbuild;
...
/**
 * Created by aivani on 2/9/2016.
 */
public class RPDCreateInstance extends Notifier {
    ...
    public RPDCreateInstance(String pack, String instanceName, String customProfile, Boolean useCustomProfile ) {
        this.pack = pack;
    ...
    public static class DescriptorImpl extends BuildStepDescriptor<Publisher> {
        ...
        public RPDCreateInstance newInstance(StaplerRequest req, JSONObject formData) throws FormException {
            ...
            return new RPDCreateInstance(formData.getString("pack"), formData.getString("instanceName"), formData.getString("customProfile"), showOptional);
        }
    }
